Pour la sélection des composants, en plus des éléments imposés par le projet, nous avons décidé d'opter d'utiliser une manette et de concevoir un modèle 3D de voiture.
